...
namespace DTO_QLNT
{
   public class GiaoVien
    {
        public GiaoVien(int maGiaoVien,string hoTen,string gioiTinh,DateTime ngaySinh,string danToc,string diaChi,string sdt,string trinhDo,DateTime ngayVaoLam,int maLop,string tonGiao)
